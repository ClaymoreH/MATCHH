...
export default function CandidateAnalysisEdit() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let candidateData = getCandidateData(currentCPF);

      // If no candidate data exists, create basic candidate profile
      if (!candidateData) {
        ...
        const profileCreated = updateCandidatePersonalData(
          currentCPF,
          basicPersonalData,
        );
        if (!profileCreated) {
          throw new Error("Erro ao criar perfil básico do candidato");
        }
      }

      // Now save the behavioral analysis
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader className="bg-blue-600 text-white">
              <CardTitle>Análise Comportamental (Soft Skills)</CardTitle>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
              <p className="text-gray-600 mb-6">
                Por favor, forneça respostas detalhadas para as perguntas
                abaixo. Suas respostas nos ajudarão a entender melhor suas
                características comportamentais, que são cruciais para o match
                ideal.
              </p>
              ...
              <div className="space-y-6">
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Descreva uma situação em que você precisou colaborar
                    intensamente com uma equipe para atingir um objetivo
                    desafiador. Qual foi a sua contribuição específica e como
                    você lidou com as diferenças de opinião?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    estrutura seu pensamento e quais passos você toma para
                    buscar uma solução eficaz? Dê um exemplo.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    diferentes públicos (ex: colegas técnicos, clientes
                    não-técnicos)? Descreva uma situação em que sua comunicação
                    foi crucial para o sucesso de uma tarefa.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Conte sobre uma vez em que você identificou uma oportunidade
                    de melhoria ou um problema em potencial e agiu para
                    resolvê-lo sem que fosse solicitado. Qual foi o resultado?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    O ambiente de trabalho é dinâmico. Descreva uma situação em
                    que você precisou se adaptar rapidamente a uma mudança
                    significativa (tecnologia, processo, meta) e como você lidou
                    com isso.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Você já precisou influenciar ou motivar outras pessoas
                    (colegas, stakeholders) para um determinado curso de ação?
                    Descreva como você fez isso e qual foi o impacto.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Quais são as últimas habilidades ou conhecimentos que você
                    buscou adquirir por conta própria? Como você se mantém
                    atualizado em sua área?
                  </Label>
                  <Textarea
          ...
          <Card>
            <CardHeader className="bg-green-600 text-white">
              <CardTitle>Expectativas e Preferências</CardTitle>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
              <div>
                <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                  Qual tipo de ambiente de trabalho você prefere? (Selecione
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={option} className="flex items-center space-x-2">
                      <Checkbox
                        id={`env-${option}`}
                        checked={formData.section2.workEnvironment.includes(
                          option,
                        )}
              ...
              <div>
                <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                  Qual o seu objetivo de carreira a médio/longo prazo (3 a 5
                  anos)?
                </Label>
                <Textarea
          ...
          <Card>
            <CardHeader className="bg-purple-600 text-white">
              <CardTitle>
                Análise de Perfil Comportamental Avançada (Para IA)
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
              <p className="text-gray-600 mb-6">
                Esta seção contém perguntas mais aprofundadas para que nossa IA
                possa construir um perfil comportamental completo e detalhado.
                Suas respostas devem ser o mais honestas e descritivas possível.
              </p>
              ...
              <div className="space-y-6">
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    trabalho ineficiente que envolve múltiplas equipes e
                    diferentes tecnologias. Quais seriam seus primeiros passos e
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Você se depara com um conjunto de dados complexos (ex:
                    vendas de um produto em diferentes regiões ao longo do
                    tempo) e precisa identificar os fatores mais impactantes no
                    declínio das vendas em uma região específica. Descreva os
                    passos que você seguiria para analisar esses dados,
                    identificar anomalias e gerar insights acionáveis.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    Você está em uma reunião de equipe e um colega apresenta uma
                    ideia que você sabe, com base em dados concretos, que é
                    inviável e pode prejudicar seriamente o projeto. Como você
                    reagiria para expressar sua preocupação de forma construtiva
                    e colaborativa, sem desmotivar o colega ou criar atritos
                    desnecessários?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Em uma situação onde há um conflito de prioridades ou
                    opiniões fortes entre dois colegas de equipe que afeta o
                    andamento do projeto, como você interviria ou o que você
                    faria para ajudar a resolver a situação e restabelecer a
                    harmonia, mesmo que não seja seu papel direto de liderança?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    Descreva uma situação em que você cometeu um erro
                    significativo no trabalho. Como você reagiu a esse erro,
                    quais ações concretas você tomou para corrigi-lo e o que
                    aprendeu com ele que o ajudou a crescer profissionalmente?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    própria direção de um projeto mudaram drasticamente e de
                    forma inesperada no meio do caminho. Como você se adaptou a
                    essa mudança, comunicou-se com a equipe e garantiu a
                    continuidade ou reorientação do trabalho?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    <strong>Motivação e Propósito:</strong> O que te impulsiona
                    a dar o seu melhor no trabalho, mesmo em face de
                    dificuldades ou de tarefas rotineiras? Dê exemplos de
                    situações em que você sentiu forte motivação e qual foi a
                    fonte dela (desafio intelectual, reconhecimento, impacto do
                    seu trabalho, aprendizado contínuo, remuneração, ambiente
                    colaborativo, etc.).
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Descreva um desafio profissional recente que você enfrentou.
                    O que te motivou a superá-lo e quais estratégias você
                    utilizou para manter-se engajado(a) e alcançar o objetivo?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    <strong>Criatividade e Pensamento Divergente:</strong>{" "}
                    Imagine que você precisa resolver um problema complexo para
                    o qual não há uma solução óbvia ou pré-existente no mercado
                    ou na sua empresa. Como você abordaria esse desafio para
                    gerar ideias criativas e inovadoras? Descreva seu processo
                    de brainstorming ou de busca por soluções não convencionais.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    ...
                    engajador, eficiente e memorável do que os métodos
                    tradicionais, quais ideias inovadoras e "fora da caixa" você
                    proporia? Descreva pelo menos três abordagens diferentes e o
                    porquê de cada uma.
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    <strong>Valores e Ética Profissional:</strong> Você se
                    depara com um dilema ético no trabalho: seguir as regras da
                    empresa estritamente pode prejudicar severamente um colega
                    ou o andamento de um projeto importante, mas "dobrar" ou
                    ignorar as regras pode beneficiá-lo em detrimento da
                    política da empresa. Como você agiria nessa situação e qual
                    seria sua justificativa para a decisão tomada?
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-sm font-semibold text-gray-900 mb-3 block">
                    Quais são os seus valores pessoais (ex: integridade,
                    justiça, inovação, colaboração, respeito) que você considera
                    inegociáveis em um ambiente de trabalho? Como você garante
                    que esses valores estejam alinhados com a cultura da empresa
                    em que você atua ou busca atuar? Dê exemplos práticos.
                  </Label>
                  <Textarea
